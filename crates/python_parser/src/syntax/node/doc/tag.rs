use crate::{
    ...
    LuaNameToken, LuaNumberToken, LuaPathToken, LuaStringToken, LuaSyntaxNode, PyTokenKind,
    LuaVersionCondition,
    kind::PySyntaxKind,
...
impl LuaAstNode for LuaDocTag {
    ...
    where
        Self: Sized,
    {
        kind == PySyntaxKind::DocTagClass
            || kind == PySyntaxKind::DocTagEnum
            || kind == PySyntaxKind::DocTagAlias
            || kind == PySyntaxKind::DocTagType
            || kind == PySyntaxKind::DocTagParam
            || kind == PySyntaxKind::DocTagReturn
            || kind == PySyntaxKind::DocTagOverload
            || kind == PySyntaxKind::DocTagField
            || kind == PySyntaxKind::DocTagModule
            || kind == PySyntaxKind::DocTagSee
            || kind == PySyntaxKind::DocTagDiagnostic
            || kind == PySyntaxKind::DocTagDeprecated
            || kind == PySyntaxKind::DocTagVersion
            || kind == PySyntaxKind::DocTagCast
            || kind == PySyntaxKind::DocTagSource
            || kind == PySyntaxKind::DocTagOther
            || kind == PySyntaxKind::DocTagNamespace
            || kind == PySyntaxKind::DocTagUsing
            || kind == PySyntaxKind::DocTagMeta
            || kind == PySyntaxKind::DocTagNodiscard
            || kind == PySyntaxKind::DocTagReadonly
            || kind == PySyntaxKind::DocTagOperator
            || kind == PySyntaxKind::DocTagGeneric
            || kind == PySyntaxKind::DocTagAsync
            || kind == PySyntaxKind::DocTagAs
            || kind == PySyntaxKind::DocTagVisibility
            || kind == PySyntaxKind::DocTagReturnCast
            || kind == PySyntaxKind::DocTagExport
            || kind == PySyntaxKind::DocTagLanguage
    }
        ...
        Self: Sized,
    {
        match syntax.kind().into() {
            ...
            PySyntaxKind::DocTagOverload => Some(LuaDocTag::Overload(
            ...
            PySyntaxKind::DocTagSee => Some(LuaDocTag::See(LuaDocTagSee::cast(syntax).unwrap())),
            PySyntaxKind::DocTagDiagnostic => Some(LuaDocTag::Diagnostic(
                LuaDocTagDiagnostic::cast(syntax).unwrap(),
            )),
            PySyntaxKind::DocTagDeprecated => Some(LuaDocTag::Deprecated(
            ...
            PySyntaxKind::DocTagNamespace => Some(LuaDocTag::Namespace(
            ...
            PySyntaxKind::DocTagNodiscard => Some(LuaDocTag::Nodiscard(
                LuaDocTagNodiscard::cast(syntax).unwrap(),
            )),
            PySyntaxKind::DocTagReadonly => Some(LuaDocTag::Readonly(
                LuaDocTagReadonly::cast(syntax).unwrap(),
            )),
            PySyntaxKind::DocTagOperator => Some(LuaDocTag::Operator(
            ...
            PySyntaxKind::DocTagAs => Some(LuaDocTag::As(LuaDocTagAs::cast(syntax).unwrap())),
            PySyntaxKind::DocTagVisibility => Some(LuaDocTag::Visibility(
                LuaDocTagVisibility::cast(syntax).unwrap(),
            )),
            PySyntaxKind::DocTagReturnCast => Some(LuaDocTag::ReturnCast(
                LuaDocTagReturnCast::cast(syntax).unwrap(),
            )),
            PySyntaxKind::DocTagExport => {
                Some(LuaDocTag::Export(LuaDocTagExport::cast(syntax).unwrap()))
            }
            PySyntaxKind::DocTagLanguage => Some(LuaDocTag::Language(
...
impl LuaAstNode for LuaDocEnumField {
    ...
    where
        Self: Sized,
    {
        kind == PySyntaxKind::DocEnumField
    }
...
impl LuaDocTagReturn {
    ...
    pub fn get_type_and_name_list(&self) -> Vec<(LuaDocType, Option<LuaNameToken>)> {
        ...
        for child in self.syntax.children_with_tokens() {
            match child.kind() {
                LuaKind::Token(PyTokenKind::TkComma) => {
                ...
                LuaKind::Token(PyTokenKind::TkName) => {
...
impl LuaDocTagSee {
    pub fn get_see_content(&self) -> Option<LuaGeneralToken> {
        self.token_by_kind(PyTokenKind::TkDocSeeContent)
    }
}
...
impl LuaAstNode for LuaDocDiagnosticCodeList {
    ...
    where
        Self: Sized,
    {
        kind == PySyntaxKind::DocDiagnosticCodeList
    }
...
impl LuaDocTagOther {
    pub fn get_tag_name(&self) -> Option<String> {
        let token = self.token_by_kind(PyTokenKind::TkTagOther)?;
